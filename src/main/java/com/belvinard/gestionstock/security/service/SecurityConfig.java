    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/articles/create").hasAnyAuthority("ROLE_ADMIN", "ROLE_STOCK_MANAGER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/articles/admin/**").hasAuthority("ROLE_ADMIN")
                        .requestMatchers("/api/v1/categories/admin/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_STOCK_MANAGER", "ROLE_SALES_MANAGER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/commandes-fournisseurs/fournisseur/*").hasAnyAuthority("ROLE_ADMIN", "ROLE_STOCK_MANAGER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/commandes-fournisseurs/*").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/commandes-fournisseurs/*/etat").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/commandes-fournisseurs/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_STOCK_MANAGER", "ROLE_SALES_MANAGER")
