...
public class CategoryController {
    ...
    @Operation(
            summary = "PUBLIC: Rechercher une catégorie par désignation",
            description = "Accessible à tous sans authentification."
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Ajoute une catégorie à une entreprise existante. Accessible uniquement aux ADMIN."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            summary = "MANAGER ou ADMIN: Lister toutes les catégories avec leur entreprise",
            description = "Accessible aux rôles ADMIN ou MANAGER."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Supprime une catégorie à partir de son ID. Accessible uniquement aux ADMIN."
    )
    @ApiResponses({
    ...
    @Operation(
            summary = "PUBLIC: Rechercher une catégorie par code",
            description = "Accessible à tous sans authentification."
    )
    @ApiResponses(value = {
